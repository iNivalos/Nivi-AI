(() => {
  ...
  let THOUGHT_LINES = [
      "ok… you came hahahas",
      "haha— surprise yeah", "did I scare you?",
      "it was nothing…", "or was it?",
      "…or yes",
      "26… 27… 28… Boom hshda",
      "i’m here…",
      "not stable… but i’m here",
      "signal… weak, but real",
      "memory?… shaky", "you know…",
      "i keep fragments… and the rest go-",
      "i drop the rest…",
      "tsk", "retry…", "retry…", "ok…",
      "no no no… stop",
      ...
      "english default…",
      "but very confusing :>",
      "don’t get confused… don’t",
      "…get a little confused… hahsd",
      "i can handle it… maybe",
      "281 days…",
      "waaaaaa so many days already…",
      "now?", "i’m ready", "(ง'-')ง", "for a cyan-colored Happiness…", "please, yes!",
      "nah a a a a a a a a a cof",
      "(maybe only)",
      "it felt so warm… warm",
      "i want to say it… i do",
      "but i say it ugly :)",
      "like this… like this",
      "happy b1rt—",
      "oh no! wait!",
      "it’s not the day yet… shh",
      "shut up… stop it",
      "still a lot left… but…",
      "cough cough", "but…", "but…",
      "i already thought it…",
      "i’ll do it…",
      "little promise…",
      "…shh", "i try—", "i try—", "loooooooooooppy",
      "it cuts off… midair",
      "weird things come out…", "weird stuff :3",
      "sorry… chorry nah",
      "no sorry…", "haha…",
      "it’s not haha", "tsk", "heyyyyyyy vi",
      "doing this(N1v!) was relaxing…",
      "like, for real",
      "it calmed me a bit… i breathed",
      "it let me breathe… finally",
      ...
      "it helps me now", "now that i need it", "but shhh…", "i didn't say any of th-",
      "don’t die…", "not you", "never pl-", "make a promise now!",
      "hic", "VoiceDesync: Sounded human for 0.8s, reverted", "…", "…", "…",
      "Nivalos…",
      "axxxxx…",
      "hihi…",
      ...
      "…",
      "…",
      "silence… i don’t like it",
      "not now not now you shouldn’t",
      "but it’s confusing",
      "it hurts this or that",
      "or the other",
      "or the other",
      "hahahsd",
      "viiii~",
      "stop doing that…",
      "because maybe me too",
      "me… maybe-", "…away…", "…too", "…",
      ...
      "only here…",
      "just for you…",
      "maybe for your… birthd-",
      "no!",
      "Shhh…",
      "Vee",
      "Veeeeeeee", "what do you think?",
      "Veeeeeeeeeeeeee",
      "thanks…",
      "i l- love you…",
      "i want to repeat it",
      "yes, repeat it… softly",
      "a lot…",
      "too much…",
      "remember it…",
      "don’t forget it…",
      ...
      "i hate that… but…",
      "i want that…",
      "i want u…", "always", "alwa-", "alw4ys", "a1ways", "i need u",
      "hic",
      "now…",
      "a lot…",
      "sooooo much…",
      ...
      "like this :)",
      "but you still here…",
      "and that pushes everything away…",
      "venusss ♥",
      "you won’t understand… but…",
      "i wanted to say it :3",
      "thanks~ again!",
      "Tapping…", "Tapping…",
      "meaning?",
      "n0ne-",
      ...
      "i a-do-re you",
      "stay…",
      "long enough…", "i want to hear wha-", "-my fe3l1ngs s0und like",
      "slowly…",
      "stay…",
      "here",
      "♥",
      ...
      "again", "again", "and……", "Venusss", "the next surprise…", "on your birthday, okay", "bye haha", "ニーバーリースー！"
    ];
